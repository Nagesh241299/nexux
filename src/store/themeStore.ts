...
import type { Theme, LayoutType, Direction } from '@/shared/types/theme'
...
type ThemeAction = {
    ...
    setRightSideNavCollapse: (payload: boolean) => void
...
export const useThemeStore = create<ThemeState & ThemeAction>()(
    persist(
        (set) => ({
            ...
            setRightSideNavCollapse: (payload) =>
                set((state) => ({
                    layout: { ...state.layout, rightSideNavCollapse: payload },
                })),
